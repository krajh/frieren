...
const connectToFrieren = async (): Promise<Client> => {
...
const disconnectFromFrieren = async (): Promise<void> => {
  if (transport) {
...
export const FrierenBridgePlugin: Plugin = async (ctx: PluginInput) => {
